...
<template>
  <el-container>
    ...
    <el-container>
      <el-main>
        <div style="color: #2c3e50; position: relative;padding-top: 10px;padding-left:5%;font-size: 25px;font-weight: bold">求购信息</div>
        <div style="position: relative;padding-left: 5%;padding-top: 10px;">
          <el-row>
            <el-col :span="4" v-for="(item, index) in result" :key="item.goods_id"  :offset="1">
              <el-card shadow="hover" style="width: 230px;height: 150px;" @click.native="checkDetails(item)">
                <div style="padding: 0px;height: 120px;">
