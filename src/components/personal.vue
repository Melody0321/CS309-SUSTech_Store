...
<!--&lt;!&ndash;                      <el-form-item label="商品ID"><span>{{ props.row.goods_id }}</span></el-form-item>&ndash;&gt;-->
<!--                      <el-form-item label="商品名称"><span>{{ props.row.goods_name }}</span></el-form-item>-->
<!--                      <el-form-item label="商品分类"><span>{{ props.row.tag }}</span></el-form-item>-->
<!--                      <el-form-item label="商品价格"><span>{{ props.row.price }}</span></el-form-item>-->
<!--                      <el-form-item label="剩余数量"><span>{{ props.row.rest_num }}</span></el-form-item>-->
...
<!--                </el-table-column>-->
                ...
                <el-table-column prop="rest_num" label="剩余数量" min-width="120"></el-table-column>
                <el-table-column prop="detail" label="商品描述" min-width="180"></el-table-column>
                <el-table-column label="操作" width="220">
                  <template slot-scope="scope">
                    ...
                    <el-dialog title="商品信息"
                        ...
                        <el-form label-position="left" :model="editForm">
                         <el-form-item label="商品名称">
                            <el-link @click="modifygoodsname">{{ editForm.goods_name }}</el-link>
                          </el-form-item>
                          <el-form-item label="商品分类"><el-link @click="modifygoodstag">{{ editForm.tag }}</el-link></el-form-item>
                          <el-form-item label="商品价格"><el-link @click="modifygoodsprice">{{ editForm.price }}</el-link></el-form-item>
                          <el-form-item label="剩余数量"><el-link @click="modifygoodsrestnum">{{ editForm.rest_num }}</el-link></el-form-item>
                          <el-form-item label="商品描述"><el-link @click="modifygoodsdetail">{{ editForm.detail }}</el-link></el-form-item>
                          <el-form-item label="上传图片" prop="headshot">
                            ...
                            <el-dialog title="上传图片"
                              ...
                              <el-button @click="goods_picture(editForm.goods_id)">
                                确定
                              </el-button>
                            </el-dialog>
                          </el-form-item>
                    ...
                    <el-button type="danger" @click="deletegoods(scope.row.goods_id)">删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
              ...
              <el-form :label-position="labelPosition" label-width="50px" :model="formLabelAlign" class="form"
                ...
                <el-row>
                  ...
                  <el-col span=6>
                    <el-row>
                      <el-form-item>
                        <el-input type="textarea" :rows="9" placeholder="Please input your description here"
...
<!--                <el-input v-model="comment_score" autocomplete="off"></el-input>-->
          ...
          <el-tab-pane label="购物车" name="fifth">
            <div class="table">
              <el-table element-loading-text="正在为您拼命加载中..." :data="shoppingcart" ref="multipleTable" style="width: 100%"
...
export default {
  ...
  methods: {
    ...
    modifygoodsname(){
      this.modifygoodsnameDialog=false
    ...
    goods_picture(ID){
      ...
      axios.post('/addGoodsPicture/'+ID,formdata).then(response => {
    ...
    recharge() {
      ...
      axios.post('/recharge', {
        ...
        axios.get('http://localhost:8443/personal/11111111').then(function (resp) {
          var Balance = document.getElementById("money");
          Balance.innerHTML = "Balance:" + resp.data.balance;
        })
      });
    },
    modifyPassword() {
